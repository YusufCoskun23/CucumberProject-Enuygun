...
public class MainPageLocators {
    ...
    public static final By firstFieldOnNeredenSearch = By.cssSelector("[data-testid='enuygun-homepage-flight-originPopularDestinations-0']");
    public static final By firstFieldOnNereyeSearch = By.cssSelector("[data-testid='enuygun-homepage-flight-destinationPopularDestinations-0']");
