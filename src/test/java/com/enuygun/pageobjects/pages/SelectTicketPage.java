...
public class SelectTicketPage extends BasePage {
    ...
    public void controlBiletTarih() throws ParseException, InterruptedException {
    ...
    public void thyBilet() throws InterruptedException {
        browser.scrollToElement(SelectTicketLocators.havayolları);
        browser.click(SelectTicketLocators.havayolları);
        List<WebElement> elements = driver.findElements(By.xpath(SelectTicketLocators.thyAirlines));
        elements.get(0).click();
    }
