package com.enuygun.core.operations;

import com.enuygun.core.synchronizations.WaitFactory;
...
public class Browser implements BrowserOperations<Browser> {
    ...
    @Override
    public Browser scrollToElement(By locator) throws InterruptedException {
        try {
